...
public class GoodsController {
	...
	public String listGoods(int pageNUM, String keyword, String searchFeild, String op, String orderFeild) {
		System.out.println("pageNUM:"+pageNUM);
		System.out.println("keyword:"+keyword);
		System.out.println("searchFeild:"+searchFeild);
		System.out.println("op:"+op);
		System.out.println("orderFeild:"+orderFeild);
		
		totalRecord = dao.getTotalRecord(keyword,searchFeild,op);
		totalPage =  (int)Math.ceil(totalRecord/ (double)pageSIZE);
		
		int start = (pageNUM-1)*pageSIZE+1;
		int end = start+pageSIZE-1;
		
		List<GoodsVo> list = dao.findAll(start, end,keyword,searchFeild,op,orderFeild);
