...
public class DBManager {
	...
	public static int getTotalRecord(String keyword, String searchFeild, String op) {
	...
	public static List<GoodsVo> findAll(int start, int end, String keyword, String searchFeild, String op, String orderFeild){
